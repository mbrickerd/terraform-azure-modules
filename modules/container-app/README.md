...
| <a name="input_location"></a> [location](#input\_location) | The location where the Container App resources will be created. | `string` | n/a | yes |
...
| <a name="input_retention_days"></a> [retention\_days](#input\_retention\_days) | The retention period for the Log Analytics Workspace logs in days. | `number` | `30` | no |
